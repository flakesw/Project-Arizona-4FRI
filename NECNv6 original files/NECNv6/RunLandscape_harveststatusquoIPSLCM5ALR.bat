...
set resultsdir=E:\Landis\Harvest_statusquoIPSLCM5ALR
...
copy %workingdir%\scenario_statusquoIPSLCM5ALR_30yrspinup.txt

rem run LANDIS
call landis-ii-7 scenario_statusquoIPSLCM5ALR_30yrspinup.txt
