...
set resultsdir=E:\Landis\NoHarvestIPSLCM5ALR
...
copy %workingdir%\scenario_noharvestIPSLCM5ALR_30yrspinup.txt

rem run LANDIS
call landis-ii-7 scenario_noharvestIPSLCM5ALR_30yrspinup.txt
