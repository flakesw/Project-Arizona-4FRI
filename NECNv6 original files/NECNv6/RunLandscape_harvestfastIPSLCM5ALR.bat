...
set resultsdir=E:\Landis\Harvest_fastIPSLCM5ALR
...
copy %workingdir%\scenario_fastIPSLCM5ALR_30yrspinup.txt

rem run LANDIS
call landis-ii-7 scenario_fastIPSLCM5ALR_30yrspinup.txt
