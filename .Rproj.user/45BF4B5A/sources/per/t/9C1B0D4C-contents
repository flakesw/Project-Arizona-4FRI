...
setwd("C:/Users/Sam/Documents/Research/Project-Arizona-4FRI/model runs/NECNv6_drought - new IC")
cwd_directory <- "./NECN/"
cwd_rasters <- list.files(cwd_directory, pattern = "CWD", full.names = TRUE)[1:30] #get first 30 years of CWD rasters
#print(cwd_rasters)
